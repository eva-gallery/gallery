...
const Formular: React.FC<ModuleFormular> = ({ data, option }) => {
   ...
   return (
      <>
         ...
         <AdminFormInput type="date" icon="date" label="Born" name="born" value={data['born']} />
         <AdminFormInput type="longtext" icon="textarea" label="Biography" name="biography" value={data['biography']} />
         <AdminFormInput type="parent" icon="globe" label="Country" name="countryId" value={data['country']?.["id"] ?? ''} option={option?.['country']} />
         <AdminFormInput type="parent" icon="category" label="Category" name="artistCategoryId" value={data['artistCategory']?.["id"] ?? ''} option={option?.['artist_category']} />
