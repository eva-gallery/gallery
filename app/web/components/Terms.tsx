        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li className="text-gray-700">
                <span className="font-medium">Platform Services</span> – Any feature offered by E.V.A. Gallery, including 3D exhibitions, NFT minting, and AI protection.
              </li>
              <li className="text-gray-700">
                <span className="font-medium">User Content</span> – Any material uploaded, shared, or published by users on the platform.
              </li>
              <li className="text-gray-700">
                <span className="font-medium">Intellectual Property Rights</span> – Legal rights concerning the ownership and usage of uploaded artworks.
              </li>
            </ul>
          </section>
